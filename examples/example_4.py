...
# Projection
cols_birth = [('age', 'employees'), ('age', 'spouses'), ('sex', 'employees'), ('sex', 'spouses')]
...
global_numb.to_excel(path_exp + "global_numbers.xlsx", index=False)
...
indiv_empl[0].to_excel(path_exp + "individual_employees_lives.xlsx", index=False)


indiv_spouses = eff.individual_spouses_numbers(numbers_[1])
indiv_spouses[4].to_excel(path_exp + "individual_spouses_res.xlsx", index=False)
