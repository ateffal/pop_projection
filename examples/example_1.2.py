...
# # Walk of employees in case of no replacement of departures:
# Numbers(year N + 1 ) = Numbers(N) - Deaths(N) - Resignations(N) - New Retirees(N)
...
# export results
employees_walk.to_csv('employees_walk.csv', sep=';', index=False, decimal=',')
